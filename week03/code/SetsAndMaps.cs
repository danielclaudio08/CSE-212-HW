...
public static class SetsAndMaps
{
    ...
    public static Dictionary<string, int> SummarizeDegrees(string filename)
    {
        ...
        foreach (var line in File.ReadLines(filename))
        {
            ...
            // Ensure there is a degree column
            if (fields.Length > 3)
            {
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        // Ensure all character counts are zero (all letters matched)
    ...
    public static string[] EarthquakeDailySummary()
    {
        ...
        // Create "[Place] - Mag [Mag.Value]" sumaries
        var result = featureCollection.Features
            .Where(f => f.Properties != null && f.Properties.Mag.HasValue && !string.IsNullOrWhiteSpace(f.Properties.Place)) // Filter out nulls
