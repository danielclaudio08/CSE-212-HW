public class Translator
{
  public static void Run()
  {
    ...
    Console.WriteLine($"Car in German: {englishToGerman.Translate("Car")}"); // Auto
    Console.WriteLine($"Plane in German: {englishToGerman.Translate("Plane")}"); // Flugzeug
    Console.WriteLine($"Train in German: {englishToGerman.Translate("Train")}"); // ???
  }
